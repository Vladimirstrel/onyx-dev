...
import './Privacy.scss';
import Image1 from '../../assets/image/onyx-white.svg';
    ...
    <div className="privacy-page">
      ...
      <div className="text-wrapper">
        <div className="container">
          <img className="privacy-logo" src={Image1} alt="img" />
          <p>
          ...
          <ul className="privacy-list">
            ...
            <li>
              ...
              this Agreement) refers to Onyx Funding LLC, 2200 NW 2nd Ave, STE 211, Miami, FL 33127.
            ...
            <li>
              <strong>Financing</strong> means any mortgage debt financing, mezzanine financing, or
              equity placement for one or more properties.
            </li>
            <li>
              <strong>Financing Source</strong> means a provider of funds for any mortgage debt
              financing, mezzanine financing, or equity placement.
            </li>
            <li>
              ...
              genetic, mental, economic, cultural or social identity. For the purposes of the CCPA,
              Personal Data means any information that identifies, relates to, describes or is
            ...
            <li>
              <strong>Website</strong> refers to Onyx Funding, accessible from{' '}
              <a href="www.onyxfunding.com" target="_blank" rel="noreferrer">
                www.onyxfunding.com
              </a>
            </li>
            <li>
          ...
          <p>
            ...
            <u>All About Cookies by TermsFeed.</u>
          </p>
          ...
          <ul className="privacy-list">
            ...
            <li>
              <strong>Functionality Cookies</strong> Type: Persistent CookiesAdministered by: Us
            </li>
            <li>
            ...
            <li>
              <strong>Tracking and Performance Cookies</strong> Type: Persistent CookiesAdministered
              by: Third-Parties
            </li>
            <li>
          ...
          <ul className="privacy-list">
            ...
            <li>
              <strong>To deliver targeted advertising to You:</strong> We may use Your information
              to develop and display content and advertising (and work with third-party vendors who
          ...
          <ul className="privacy-list">
            <li>
              ...
              advertising network.You can opt-out of having made your activity on the Service
              available to Google Analytics by installing the Google Analytics opt-out browser
              add-on. The add-on prevents the Google Analytics JavaScript (ga.js, analytics.js and
          ...
          <ul className="privacy-list">
            <li>
              <strong>SendGrid</strong>Their Privacy Policy can be viewed at{' '}
          ...
          <ul className="privacy-list">
            ...
            <li>
              ...
              <a href="http://optout.aboutads.info/?c=2&lang=EN" target="_blank" rel="noreferrer">
          ...
          <ul className="privacy-list">
            <li>
              <strong>Twitter </strong> remarketing service is provided by Twitter Inc.You can
              opt-out from Twitter’s interest-based ads by following their instructions:{' '}
              <a
            ...
            <li>
              <strong>Facebook</strong> remarketing service is provided by Facebook Inc.You can
              learn more about interest-based advertising from Facebook by visiting this page:{' '}
              <a
            ...
            <li>
              <strong>Pinterest</strong> remarketing service is provided by Pinterest Inc.You can
              opt-out from Pinterest’s interest-based ads by enabling the “Do Not Track”
          ...
          <ul className="privacy-list">
            ...
            <li>
              <strong>Public interests:</strong> Processing Personal Data is related to a task that
              is carried out in the public interest or in the exercise of official authority vested
              in the Company.
            </li>
            <li>
          ...
          <ul className="privacy-list">
            <li>
              ...
              delete the information We have on You. Whenever made possible, you can access, update
              or request deletion of Your Personal Data directly within Your account settings
              section. If you are unable to perform these actions yourself, please contact Us to
              assist You. This also enables You to receive a copy of the Personal Data We hold about
              You.
            </li>
            <li>
            ...
            <li>
              ...
              our processing of Your Personal Data on this ground. You also have the right to object
          ...
          <p>
            ...
            to such requests. If You make a request, We will try our best to respond to You as soon
            as possible.
          </p>
          <p>
          ...
          <ul className="privacy-list">
            <li>
              <strong>Category A: Identifiers.</strong>Examples: A real name, alias, postal address,
              unique personal identifier, online identifier, Internet Protocol address, email
              address, account name, driver’s license number, passport number, or other similar
              identifiers.Collected: Yes.
            </li>
            <li>
              <strong>
            ...
            <li>
              ...
              status, genetic information (including familial genetic information).Collected: No.
            </li>
            <li>
              <strong>Category D: Commercial information.</strong> Examples: Records and history of
              products or services purchased or considered.Collected: No.
            </li>
            <li>
              <strong>Category E: Biometric information.</strong> Examples: Genetic, physiological,
              behavioral, and biological characteristics, or activity patterns used to extract a
              template or other identifier or identifying information, such as, fingerprints,
              faceprints, and voiceprints, iris or retina scans, keystroke, gait, or other physical
              patterns, and sleep, health, or exercise data.Collected: No.
            </li>
            <li>
              <strong>Category F: Internet or other similar network activity.</strong>Examples:
              Interaction with our Service or advertisement.Collected: Yes.
            </li>
            <li>
              <strong>Category G: Geolocation data.</strong>Examples: Approximate physical
              location.Collected: No.
            </li>
            <li>
              <strong>Category H: Sensory data.</strong>Examples: Audio, electronic, visual,
              thermal, olfactory, or similar information.Collected: No.
            </li>
            <li>
              <strong>Category I: Professional or employment-related information.</strong>Examples:
            ...
            <li>
              ...
              student disciplinary records.Collected: No.
            </li>
            <li>
          ...
          <ul>
            ...
            <li>
              ...
              and analyze the use of our Service, third-party vendors to deliver targeted
              advertising to You, or other third-party vendors that We use to provide the Service to
              You.
            </li>
          </ul>
          ...
          <ul>
            ...
            <li>
              <strong>The right to request.</strong>Under CCPA, You have the right to request that
              We disclose information to You about Our collection, use, sale, disclosure for
              business purposes and share of personal information. Once We receive and confirm Your
            ...
            <li>
              <strong>The right not to be discriminated against.</strong>You have the right not to
          ...
          <ul>
            <li>
              By email:{' '}
              <a href="mailto:support@onyxfunding.com" target="_blank" rel="noreferrer">
          ...
          <br />
          <br />
          <h3>Credit Report Authorization</h3>
          <p>
            Upon prior authorization by You, the Company may obtain (for itself or on behalf of a
            Financing Source) consumer reports from consumer reporting agencies about You in
            connection with a potential Financing.
          </p>
          <p>
            You expressly authorize the Company and each Financing Source to use such consumer
            reports about You, and information derived therefrom, in connection with:
          </p>
          <p>
            (i) Your Financing, including determining Your eligibility, verifying Your identity, and
            verifying information You provide to the Company or a Financing Source;
          </p>
          <p>
            (ii) marketing, including pre-qualifications and other forms of marketing, for a
            Financing You obtain from a Financing Source;
          </p>
          <p>
            (iii) the Company’s internal use, including statistical analyses and to develop,
            improve, analyze, study, and maintain products and services we may offer.
          </p>
          <h2>
